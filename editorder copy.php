...
$emp_id = $_SESSION["username"];
// echo "$status_order";
$SEE_delivery_date=$_REQUEST['SEE_delivery_date'];
$actionxxx=$_REQUEST['actionxxx'];
echo "SEE_delivery_date";
echo"$actionxxx";
...
<body class="text-left">
                                ...
                                <div class="form-row mt-3">
                                    ...
                                    ?>
                                        <div class="form-group col-md-2">
                                            ...
                                            <input id="AA_delivery_date"  type="date"  value="<?php echo "$main[delivery_date]"; ?>" class="form-control"  >
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label for="delivery_Address"><strong>ที่อยู่ จัดส่ง<span class="text-danger"></span></strong></label>
                                            <input id="AA_delivery_Address" type="text" value="<?= $main['delivery_Address'] ?>" class="classcus form-control" readonly>
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="date_confirm"><strong>ยืนยันใน(วัน) <span class="text-danger"></span></strong></label>
                                            <input id="AA_date_confirm"  type="text" value="<?= $main['date_confirm'] ?>" class="classcus form-control" readonly>
                                        </div>
                                    <?php
                                    } ?>
                                    <div class="form-group col-md-1">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="discount_text" id="AA_discount_text" value="<?= $main['discount_text'] ?>" class="classcus form-control" placeholder="รายละเอียดส่วนลด">
                                    </div>
                                    <div class="form-group col-md-1">
                                        <label for="discount"><strong>ส่วนลด(บาท) <span class="text-danger"></span></strong></label>
                                        <input type="text" name="discount" id="AA_discount" value="<?= $main['discount'] ?>" class="classcus form-control" placeholder="ส่วนลด">
                                    </div>
                                </div>
                                <button id="btu1x" class="btn btn-outline-primary m-1" data-style="expand-left">
                                                    <span class="ladda-label">แก้ไขข้อมูลใบสั่งสินค้า</span>
                                                </button>
                                <hr>
    ...
    <form  class="d-none" method="GET">
        ...
        <input type="text" id="SEE_delivery_date" name="SEE_delivery_date" value="<?php echo $SEE_delivery_date; ?>" placeholder="">
        <input type="text" id="SEE_delivery_Address" name="delivery_Address" value="<?php echo $delivery_Address; ?>" placeholder="">
        <input type="text" id="SEE_date_confirm" name="date_confirm" value="<?php echo $date_confirm; ?>" placeholder="">
        <input type="text" id="SEE_discount_text" name="discount_text" value="<?php echo $discount_text; ?>" placeholder="">
        <input type="text" id="SEE_discount" name="discount" value="<?php echo $discount; ?>" placeholder="">
        <input type="text"  name="actionxxx" value="1">
        <button class="btn" id="FSBtusave" type="submit"></button>
    
    </form>
    <div class="modal fade" id="ModalLoadIdx" tabindex="-1" role="dialog" aria-labelledby="modalLoadTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
    ...
    $("#btu1x").click("change", function() {
        modalLoad();
      
        let EE_delivery_date = $("#AA_delivery_date").val();
        let EE_delivery_Address = $("#AA_delivery_Address").val();
        let EE_date_confirm= $("#AA_date_confirm").val();
        let EE_discount_text= $("#AA_discount_text").val();
        let EE_discount= $("#AA_discount").val();
     console.log(EE_delivery_date);
        $("#SEE_elivery_date").val(EE_delivery_date);
        $("#SEE_delivery_Address").val(EE_delivery_Address);
        $("#SEE_date_confirm").val(EE_date_confirm);
        $("#SEE_discount_text").val(EE_discount_text);
        $("#SEE_discount").val(EE_discount);
        $("#FSBtusave").click();
    });
