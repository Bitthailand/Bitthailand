...
// หักมัดจำ
$sql_sum1 = "SELECT SUM(ai_number.price) AS price   FROM delivery  where  MONTH(delivery.dev_date) = '$d[1]'  AND YEAR(delivery.dev_date) = '$d[0]'  AND  ai_number.aix_status = '0' AND   delivery.status_chk='1' AND delivery.status_payment='1' AND delivery.cus_type='1' ";
