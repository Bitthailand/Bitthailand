...
$hs_id = $dat . $code;
$sqlx = "SELECT * FROM hs_number  WHERE order_id='$order_id'  ";
...
$sql_hs = "SELECT * FROM delivery  WHERE  order_id='$order_id'";
...
<body>
    ...
    $sql = "SELECT * FROM deliver_detail INNER JOIN product_type  ON deliver_detail.ptype_id=product_type.ptype_id  AND deliver_detail.order_id='$order_id'   ORDER BY  product_type.num_orderby,deliver_detail.date_create ASC";
    $i = 1;
