                ...
                if (mysqli_num_rows($resultxx) > 0) {
                    while ($rowx = mysqli_fetch_assoc($resultxx)) { ?>
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name='a_type[<?=$product_id?>][<?=++$idx;?>]' placeholder="ใส่ข้อมูล"></td>
                            <td><input class="form-control" type="text" name='b_type[<?=$product_id?>][<?=++$idx1;?>]' placeholder="ใส่ข้อมูล"></td>
                        </tr>
                <?php }
                } ?>
