...
<script>
    function reP() {
        window.location.href = 'tools_bin_report.php';
    }
</script>
                            ...
                            <div class="mb-1">
                                <div class="ul-widget__item">
                                    <div class="ul-widget__info">
                                        <h3 class="ul-widget1__title ">เครื่องมือช่างชำรุด จำหน่ายออก </h3>
                                            ...
                                            <div class="table-responsive">
                                                <table class="display table table-striped table-bordered" id="orderby1" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $result = mysqli_query($conn, "SELECT * FROM tools_out    order by date_out  ASC  ");
