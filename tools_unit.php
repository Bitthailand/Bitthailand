...
if ($action == 'del') {
    ...
    $sql = "DELETE FROM unit_tools   WHERE id='$del_id' ";
...
if ($action == 'add') {
    ...
    $sqlx = "SELECT * FROM unit_tools WHERE name='$name' ";
    ...
    if (mysqli_num_rows($result) > 0) { ?>
        ...
        <?php    } else {
        $sql = "INSERT INTO unit_tools(name,status)
                   VALUES ('$name','1')";
        if ($conn->query($sql) === TRUE) {  ?>
            <script>
                $(document).ready(function() {
...
if ($action =='edit') {
    ...
    $name = $_REQUEST['name'];
    $sqlxxx = "UPDATE unit_tools  SET name='$name' where id='$edit_id'";
                            ...
                            <div class="mb-1">
                                <div class="ul-widget__item">
                                    <div class="ul-widget__info">
                                        ...
                                        <span class="ul-widget__desc "> รายการหน่วยนับเครื่องมือ</span>
                                    </div>
                                    <div class="text-left">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <button type="button" class="btn btn-outline-primary mt-4" data-toggle="modal" data-target="#Modal-add"><i class="fa fa-plus"></i> เพิ่มหน่วยนับเครื่องมือช่าง
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap table-sm">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        $result_count = mysqli_query($conn, "SELECT COUNT(*) As total_records FROM `unit_tools` where  status='0' $columx $keywordx  ");
                                        $total_records = mysqli_fetch_array($result_count);
                                        $total_records = $total_records['total_records'];
                                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                        $second_last = $total_no_of_pages - 1; // total page minus 1

                                        $result = mysqli_query($conn, "SELECT * FROM `unit_tools` where status='1' $columx $keywordx LIMIT $offset, $total_records_per_page");
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" name="name" id="name" class="classcus form-control" placeholder="ชื่อหน่วยนับเครื่องมือช่าง">
                                        </div>
