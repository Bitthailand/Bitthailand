...
<head>
    ...
    <title>Invoice | Gull Admin Template</title>
                    ...
                    <div class="topnav rtl-ps-none" id="" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                        <ul class="menu float-left">
                            ...
                            <li>
                                <div>
                                    <div>
                                        ...
                                        <input id="drop-2" type="checkbox" />
                                        <ul>
                                            <li class="nav-item"><a href="../sessions/signin.html" title="charts"><i class="nav-icon mr-2 i-Checked-User"></i><span class="item-name">Signin</span></a></li>
                                            <li class="nav-item"><a href="../sessions/signup.html"><i class="nav-icon mr-2 i-Add-User"></i><span class="item-name">Sign Up</span></a></li>
                                            <li><a href="../sessions/forgot.html"><i class="nav-icon mr-2 i-Add-User"></i>Forgot</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!--end-sessions-->
                            <li>
                                <div>
                                    <div>
                                        <label class="toggle" for="drop-2">Others</label><a href="#"><i class="nav-icon mr-2 i-Double-Tap"></i>Others</a>
                                        <input id="drop-2" type="checkbox" />
                                        <ul>
                                            <li class="nav-item"><a href="../sessions/not-found.html" title="charts"><i class="nav-icon mr-2 i-Error-404-Window"></i><span class="item-name">Not Found</span></a></li>
                                            <li class="nav-item"><a href="user.profile.html"><i class="nav-icon mr-2 i-Male"></i><span class="item-name">User Profile</span></a></li>
                                            <li><a href="blank.html"><i class="nav-icon mr-2 i-File-Horizontal"></i>Blank Page</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div>
                                    <div>
                                        <label class="toggle" for="drop-2">Doc</label><a href="http://demos.ui-lib.com/gull-html-doc/"><i class="nav-icon mr-2 i-Safe-Box1"></i>Doc</a>
                                    </div>
                                </div>
                            </li>
                            <!--end-doc  -->
