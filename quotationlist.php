                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap table-sm">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        $result = mysqli_query($conn, "SELECT * FROM `orders` where status='0'  AND order_status='1'  AND status_button='1' $columx $keywordx  order by qt_date,order_id DESC  LIMIT $offset, $total_records_per_page");
