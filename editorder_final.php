...
if ($action == 'add_product') {
    ...
    VALUES ('$Forder_id','$Fcus_id','$Fcus_back','$Fcus_type_id','$emp_id','0')";
        ...
        VALUES ('$Forder_id','$Fproduct_type','$row5[product_id]','$send_qty','$send_price','$send_total','1','$emp_id','TF','$send_qty','1','2')";
                                ...
                                <div class="text-right">
                                    ...
                                    ?>
                                        ...
                                        <?php if ($rs['cus_type'] == 2) { ?>
                                            <a class="btn btn-outline-primary m-1" href="/quotation.php?order_id=<?= $rs['order_id'] ?>" type="button" target="_blank">ออกใบเสนอราคา(QT)</a>
                                        <?php } ?>
                                        <a class="btn btn-outline-primary m-1" href="/ordersuccesslist.php?order_id=<?= $order_id ?>" type="button" target="_blank">ออกใบเสนอราคา(QT)</a>
