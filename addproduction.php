    ...
    function fncASum() {
        {
            ...
            document.frmAMain['sqm'].value = (document.frmAMain['qty'].value * sqmx).toFixed(2);
            document.frmAMain['concrete_cal'].value = (document.frmAMain['qty'].value * concrete_calx).toFixed(2);
