                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        if (mysqli_num_rows($result4) > 0) {
                                                                            while ($row4 = mysqli_fetch_assoc($result4)) {
                                                                                ...
                                                                                $sql_sum1 = "SELECT SUM(ai_number.price) AS price   FROM delivery  where   delivery.dev_date ='$row4[dev_date]' AND    delivery.status_chk='1' AND delivery.status_payment='1' AND delivery.cus_type='1' ";
