...
<div class="col-12 text-right">
                <input id="btn_convert" type="button" value="บันทึกรูปภาพ" />
</div>
                <br />
...
style = "width: 1200px; margin:15px; padding: 15 px;
">    
                                                                ...
                                                                <div class="col-7 mb-3 mb-sm-0"> <?php
                                                                                ...
                                                                                <div class="rowx_cus">
                                                                                                ...
                                                                                                <div class="col-4xx_cus">
                                                                                                                ...
                                                                                                                <p style="font-size: 18px;"><?php if ($rowx['contact_name'] == '-') {
                                                                                                                                                                echo $row3['contact_name'];
                                                                                                                                                } else {
                                                                                                                                                                echo $rowx['contact_name'];
                                                                                                                                                } ?></p>

                                                                                                </div>
                                                                                                <div class="rowx_cus">
                                                                                                                <p style="font-size: 18px;font-weight: 700; padding-left: 4px;">เลขประจำตัวผู้เสียภาษี &nbsp; </p>
...
<script>
                document.getElementById("btn_convert").addEventListener("click", function() {
                                html2canvas(document.getElementById("html-content-holder"), {
                                                ...
                                                anchorTag.download = "<?=$order_id?>.jpg";
