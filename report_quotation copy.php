                                                        ...
                                                        <div class="ul-widget1">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table text-center" id="user_table">
                                                                    ...
                                                                    <tbody>
                                                                        <?php $sql4 = "SELECT  DATE_FORMAT(quotation.date_create, '%Y-%m-%d') AS DATE  FROM quotation  INNER JOIN   order_details  ON  quotation.order_id=order_details.order_id   AND quotation.date_create  BETWEEN NOW() - INTERVAL 30 DAY  AND NOW() GROUP BY DATE ORDER BY DATE DESC";
