...
<head>
    ...
    <link href="../../dist-assets/css/themes/styleforprint.css?v=15" rel="stylesheet" />
                            ...
                            <div class="row">
                                <div class="col-12 table-responsive">
                                    <table class="table table-hover mb-4">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql_pro = "SELECT * FROM deliver_detail  where order_id='$order_id'  AND dev_id='$so_id'  AND ptype_id <> 'TF' order by date_create ASC ";
