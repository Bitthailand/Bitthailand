                                                ...
                                                <table class="table text-center" id="user_table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?> <tr>
                                                                    ...
                                                                    <td class="text-right"><?php echo number_format($row_sum['discount'], '2', '.', ',');
                                                                                            $total_discount = $total_discount + $row_sum['discount']; ?></td>
                                                                    <td class="text-right"><?php echo number_format($row_sum['total'], '2', '.', ',');
                                                                                            $total = $total + $row_sum['total']; ?></td>
