                                                                ...
                                                                <table class="table text-center" id="user_table">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th scope="col" class="text-right">ข้อความ</th>
                                                                    ...
                                                                    <tbody>
                                                                        <?php $sql4 = "SELECT * FROM ai_number  WHERE aix_status='0' AND pay_full='0'   ORDER BY date_create DESC";
