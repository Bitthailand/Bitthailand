...
if ($action == 'del') {
    ...
    $sql = "DELETE FROM unit   WHERE id='$del_id' ";
...
if ($action =='edit') {
    ...
    $unit_name = $_REQUEST['unit_name'];
    $sqlxxx = "UPDATE unit  SET unit_name='$unit_name' where id='$edit_id'";
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap table-sm">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        $result_count = mysqli_query($conn, "SELECT COUNT(*) As total_records FROM `unit` where  status='0' $columx $keywordx  ");
                                        $total_records = mysqli_fetch_array($result_count);
                                        $total_records = $total_records['total_records'];
                                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                        $second_last = $total_no_of_pages - 1; // total page minus 1

                                        $result = mysqli_query($conn, "SELECT * FROM `unit` where status='0' $columx $keywordx LIMIT $offset, $total_records_per_page");
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" name="unit_name" id="unit_name" class="classcus form-control" placeholder="ความกว้างแพ">
                                        </div>
