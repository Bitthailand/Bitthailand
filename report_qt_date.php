                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table text-center" id="user_table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        $sql4 = "SELECT  orders.cus_id AS cus_id, orders.order_id  AS order_id , orders.cus_type AS cus_type,orders.cus_back AS cus_back, orders.order_status AS order_status  FROM quotation  INNER JOIN   orders   ON  quotation.order_id=orders.order_id   AND  DAY(quotation.date_create)= '$d[2]' AND MONTH(quotation.date_create) = '$d[1]' AND YEAR(quotation.date_create) = '$d[0]'   ";
