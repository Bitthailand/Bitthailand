                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap table-sm">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        $result = mysqli_query($conn, "SELECT * FROM `orders` where status='0'  AND order_status='2'  $columx $keywordx   order by delivery_date  DESC ,date_create ASC LIMIT $offset, $total_records_per_page");
