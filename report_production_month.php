                                                ...
                                                <table class="table text-center" id="user_table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?> <tr>
                                                                    ...
                                                                    <td class="text-left"><a class="btn btn-outline-success btn-sm line-height-1" data-toggle="tooltip" title="ดูข้อมูลรายเดือน" href="/report_production_date.php?MyMonth=<?= $row4['MyMonth'] ?>">
