                            ...
                            <div class="table-responsive">
                                <table role="table" class="table table-hover text-nowrap table-sm">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        $result = mysqli_query($conn, "SELECT * FROM `bi_number`   where status='0'  $colum_po  GROUP BY bi_number  ORDER BY date_create DESC LIMIT $offset, $total_records_per_page");
                                            ...
                                            if (mysqli_num_rows($resultxx) > 0) {
                                                ...
                                                while ($row2 = mysqli_fetch_array($resultxx)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <?php if ($x == 0) { ?>
                                                            <a class="btn btn-outline-success btn-sm line-height-1" data-toggle="tooltip" title="" href="bi_view.php?bi_id=<?=$row['bi_number']?>" data-original-title="ออกใบวางบิล">
                                                                <i class="i-Pen-2 font-weight-bold"></i>
                                                            </a>
                                                            <?php  
                                                                  if($row['status_bi']==1){        
                                                            ?>
                                                            <a class="btn btn-outline-success btn-sm line-height-1" data-toggle="tooltip" title="" href="bi.php?bi_id=<?=$row['bi_number']?>" data-original-title="บันทึกการชำระเงินใบวางบิล">
                                                                <i class="i-Pen-2 font-weight-bold"></i>
                                                            </a>
                                                            <?php  }
                                                                  if($row['status_bi']==2){        
                                                            ?>
                                                            <a class="btn btn-outline-success btn-sm line-height-1" data-toggle="tooltip" title="" href="re_view.php?re_id=<?=$row['re_id']?>" data-original-title="ใบเสร็จชำระเงิน (RE)">
