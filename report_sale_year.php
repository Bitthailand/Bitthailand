                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-center" id="user_table">
                                                    ...
                                                    <tbody>
                                                        <?php  $sql4 = "SELECT DATE_FORMAT(delivery.dev_date,'%Y') As MyYear ,SUM(discount) AS discount   FROM delivery  WHERE    status_chk='1' AND status_payment='1'   GROUP BY MyYear ORDER BY MyYear  DESC ";
                                                        ...
                                                        ?> <tr>
                                                                    ...
                                                                    <td class="text-right"> <a data-toggle="modal" data-target="#view-modal2" data-id="<?php echo $row4['dev_date']; ?>" id="edit2" class="btn  btn-sm line-height-1"><?php echo number_format($row_ai['total'], '2', '.', ',');
