...
if ($action == 'del') {
    ...
    $sql = "DELETE FROM product_type   WHERE id='$del_id' ";
...
if ($action =='edit') {
    ...
    $ptype_id = $_REQUEST['ptype_id'];
    $ptype_name = $_REQUEST['ptype_name'];
    $sqlxxx = "UPDATE product_type  SET ptype_name='$ptype_name' where id='$edit_id'";
                            ...
                            <div class="mb-1">
                                <div class="ul-widget__item">
                                    <div class="ul-widget__info">
                                        ...
                                        <span class="ul-widget__desc "> รายการประเภทสินค้า </span>
                                    </div>
                                    <div class="text-left">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <button type="button" class="btn btn-outline-primary mt-4" data-toggle="modal" data-target="#Modal-add"><i class="fa fa-plus"></i> เพิ่มประเภทสินค้าใหม่
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap table-sm">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        $result_count = mysqli_query($conn, "SELECT COUNT(*) As total_records FROM `product_type` where  status='0' $columx $keywordx  ");
                                        $total_records = mysqli_fetch_array($result_count);
                                        $total_records = $total_records['total_records'];
                                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                        $second_last = $total_no_of_pages - 1; // total page minus 1

                                        $result = mysqli_query($conn, "SELECT * FROM `product_type` where status='0' $columx $keywordx LIMIT $offset, $total_records_per_page");
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="ptype_id" id="ptype_id" class="classcus form-control" placeholder="รหัสแพ" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="accNameId"><strong>ชื่อประเภทสินค้า<span class="text-danger"></span></strong></label>
                                            <input type="text" name="ptype_name" id="ptype_name" class="classcus form-control" placeholder="ความกว้างแพ">
                                        </div>
