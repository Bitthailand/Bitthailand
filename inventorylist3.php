                                    ...
                                    <tbody id="myTable">
                                        ...
                                        while ($row = mysqli_fetch_array($result)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                <?php
                                                                $sql_pro = "SELECT sum(order_details.qty_out) AS qty_out FROM order_details INNER JOIN orders ON order_details.product_id= '$row[product_id]' AND order_details.order_id=orders.order_id AND orders.order_status='5' AND orders.is_ai='Y' ";
