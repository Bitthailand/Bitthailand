...
<head>
    ...
    <link href="../../dist-assets/css/themes/styleforprint2.css?v=2" rel="stylesheet" />
</head>
...
<body>
    ...
    $sql = "SELECT * FROM order_details  where order_id='$order_id'  AND ptype_id <> 'TF' order by product_id ASC";
    $i = 1;
        ...
        <div class="col-12">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <h5 class="font-weight-bold">ใบเสนอราคา/ใบสั่งซื้อ</h5>
                    </div>
                </div>
            ...
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-top:5px double #000;margin: 15px;  ">
                ...
                for ($v = 1; $v <= $total_page_item; $v++) {
                    ...
                    $_name_th = isset($arr_data_set['product_id'][$item_i]) ? $arr_data_set['product_id'][$item_i] : "";
            ...
            <div class="page-footer">
                ...
                <div class="col-12">
                    <div class="col-12 mb-3 mb-sm-0">
                        ...
                        <p>2.ผู้ซื้อเป็นผู้จัดเตรียมสถานที่สำหรับลงสินค้า และทางบริษัทฯ ขอสงวนสิทธิ์ในการลงสินค้าตามสถานที่เท่าที่รถเข้าถึง </p>
